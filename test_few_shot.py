...
import open_clip
from utils.memory_gallery import memory, get_normal_scoremap
from utils import *
    ...
    for idx, items in enumerate(tqdm(test_dataloader)):
        ...
        with torch.no_grad(), torch.cuda.amp.autocast():
            ...
            if args.mode == 'few_shot':
                ...
                norm_anomaly_map = get_normal_scoremap(cls_name[0], aligned_feature_maps, visionAdapter, text_prompts) # [1, 37, 37]

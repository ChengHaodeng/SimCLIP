...
# --------------------------------------------------------------------
checkpoint_path='pretrain_weights/train_on_visa/trainable_epoch_20.pth'
clip_path='pretrain_weights/train_on_visa/clip_epoch_20.pth'

zero_shot_sp='test/mvtec/0shot'
one_shot_sp='test/mvtec/1shot'
two_shot_sp='test/mvtec/2hot'
four_shot_sp='test/mvtec/4shot'

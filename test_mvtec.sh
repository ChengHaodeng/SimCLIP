# Reproduce the zero-shot and few-shot(1-shot, 2-shot and 4-shot) anomaly segmentation and classification results of SimCLIP on the MVTec dataset.
...
# ----------------------------------------------------------------------
checkpoint_path='pretrain_weights/train_on_visa/trainable_epoch_20.pth' # path to pretrained weights
clip_path='pretrain_weights/train_on_visa/clip_epoch_20.pth'            

zero_shot_sp='test/mvtec/0shot' # path to save 0-shot results
one_shot_sp='test/mvtec/1shot'  # path to save 1-shot results
two_shot_sp='test/mvtec/2hot'   # path to save 2-shot results
four_shot_sp='test/mvtec/4shot' # path to save 4-shot results
